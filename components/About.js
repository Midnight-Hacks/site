    ...
    return (
        <section className={aboutStyles.background} id="about">
            ...
            <div className={aboutStyles.contentContainer}>
                ...
                <span className={aboutStyles.subtext}><strong>Midnight hacks</strong> is a 12-hour hackathon designed for beginner coders. Many schools in New York don't have hackathons hosted within their school, allowing students to miss out on memorable experiences, and opportunities to learn and build. <br /> <br />Our goal is to make a calm, low-pressure event for middle school and high school students in New York (and beyond) so they can learn to code, and gain memorable experiences along the way. You can work in up to teams of 4, and design and build a project from scratch. We'll also have workshops hosted throughout the event, so there's always an opportunity to learn something new.</span>
            </div>
        </section>
    );
}
