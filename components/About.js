    ...
    return (
        <section className={aboutStyles.background} id="about">
            ...
            <div className={aboutStyles.contentContainer}>
                ...
                <span className={aboutStyles.subtext}><strong>Midnight hacks</strong> is a 24-hour hackathon designed for beginner coders. Many schools in New York don't have hackathons hosted within their school, or often don't do a very good job at showing students the true magic of coding. Students miss out on memorable experiences, and opportunities to learn and build.<br /> <br />That doesn't mean all schools are bad at this. The event organizers were lucky enough to have their very own high school host a hackathon, and that event managed to inspire them to continue coding and eventually attend hackathons <strong>weekly</strong> at one point. The only issue is, the hackathon that kick started their journies into the magical coding world was only restricted to the students of that school. Every other student that didn't go to that school missed out on a beautiful experience.
