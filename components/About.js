    ...
    return (
        <section className={aboutStyles.background} id="about">
            ...
            <div className={aboutStyles.contentContainer}>
                ...
                <br /> <br />That doesn't mean all schools are bad at this. The event organizers were lucky enough to have their very own high school host a hackathon, and that event managed to inspire them to continue coding and eventually attend hackathons <strong>weekly</strong> at one point. The only issue is, the hackathon that kick started their journies into the magical coding world was only restricted to the students of that school. We want to change that, and create an event with similar impact that's open to the outside world.
